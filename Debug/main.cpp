...
{   
		if(argc != 4){
				...
				if(strcmp(command, "compress")==0){
						...
						frequency_for_char(reader, freq);//chete faila s direktoriite i suzdava map s chestoti
						string map_bits_string = map_to_bit_string(freq);//string ot bitove za chestotite
						...
						string p;
						newalphabet(huffman_tree_root, p, codemap);
